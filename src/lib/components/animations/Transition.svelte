<script>
	...
	// params = delay, duration, easing: (t), css: (t, u), tick: (t, useDebugValue(value))
</script>
...
<section>
	{#if isReady}
		...
		<div>
			<h3>Draw</h3>
			<svg height="100px" width="100px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 103 124">
				<g>
					<path
						fill="transparent"
						transition:draw
